...
const appCacheName = 'nbsite-0.9.0a9';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.7.2/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
