...
const appCacheName = 'nbsite-0.8.4';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.2.3/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
